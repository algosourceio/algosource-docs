...
import { Search, FolderTree, GitBranch, Layers, Puzzle, Map, Eye, FileCode } from 'lucide-react'

<Callout type="info" title="The Art of Code Archaeology">
...
<Steps>
<Step number={1} title="Check package.json / pyproject.toml">
```json
{
...
<Step number={2} title="Look for obvious filenames">
...
<Step number={3} title="Follow the framework conventions">
...
<Steps>
<Step number={1} title="Follow the imports">
...
<Step number={5} title="Read the tests">
...
<Checklist>
<ChecklistItem>Where is the feature I'm modifying defined?</ChecklistItem>
<ChecklistItem>What other files import this file?</ChecklistItem>
<ChecklistItem>Where are the tests for this code?</ChecklistItem>
<ChecklistItem>What configuration affects this code?</ChecklistItem>
<ChecklistItem>What side effects does this function have?</ChecklistItem>
</Checklist>
...
<NextSteps items={[
  { title: "Choosing Your First Issue", description: "Find the right issue to work on", href: "/docs/getting-started/choosing-issues" },
  { title: "First Contribution", description: "Ready to submit a PR", href: "/docs/first-contribution" }
]} />
