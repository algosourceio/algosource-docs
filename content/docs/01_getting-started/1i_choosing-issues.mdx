...
import { Target, Search, Tag, CheckCircle, AlertTriangle, Clock, Star, GitPullRequest } from 'lucide-react'

<Callout type="info" title="The Right Issue Makes All The Difference">
...
<CardGrid>
<Card title="Documentation" icon={<Target className="h-5 w-5 text-emerald-400" />}>
...
<Card title="Bug Fixes" icon={<Target className="h-5 w-5 text-emerald-400" />}>
...
<Card title="Test Coverage" icon={<Target className="h-5 w-5 text-yellow-400" />}>
...
<Card title="Small Features" icon={<Target className="h-5 w-5 text-yellow-400" />}>
...
<Warning title="Avoid These for First Contribution">
- Major new features
- Breaking changes
...
<Step number={5} title="Comment to claim">
...
<Step number={6} title="Wait for response">
...
<Checklist>
<ChecklistItem>Issue has a beginner-friendly label</ChecklistItem>
<ChecklistItem>Issue was active in the last 3 months</ChecklistItem>
<ChecklistItem>No one is currently assigned or working on it</ChecklistItem>
<ChecklistItem>I fully understand what needs to be done</ChecklistItem>
<ChecklistItem>I know where the relevant code lives</ChecklistItem>
<ChecklistItem>Scope is small enough for one PR</ChecklistItem>
<ChecklistItem>I've commented to claim and got acknowledgment</ChecklistItem>
<ChecklistItem>I'm ready to work on it within the next few days</ChecklistItem>
</Checklist>

<NextSteps items={[
  { title: "Making Your First Contribution", description: "Let's write the code!", href: "/docs/first-contribution" },
  { title: "Writing Code", description: "Jump to the coding phase", href: "/docs/writing-code" }
]} />
