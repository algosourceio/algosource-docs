...
import { MessageSquare, ThumbsUp, ThumbsDown, GitCommit, Users, CheckCircle } from 'lucide-react'

<Callout type="success" title="Code Review is a Gift">
...
<Callout type="warning" title="Don't Disappear">
...
<Callout type="info" title="Separate Tone from Content">
...
<Warning title="Remember: They Have Veto Power">
...
<Callout type="tip" title="Commit Granularity">
...
<Callout type="success" title="Build a Reputation">
...
<CardGrid>
<Card title="Handling Rejection" icon={<ThumbsDown className="h-5 w-5" />}>
Learn [how to handle rejection](/docs/issues-prs/handling-rejection) without burning bridges.
</Card>

<Card title="Iterating on Feedback" icon={<GitCommit className="h-5 w-5" />}>
