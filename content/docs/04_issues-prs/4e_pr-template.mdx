...
import { Copy, FileText, Bug, Sparkles, Book } from 'lucide-react'
...
<Callout type="tip" title="Customize the Template">
...
<CardGrid>
<Card title="Responding to Reviews" icon={<FileText className="h-5 w-5" />}>
Learn [how to handle code reviews](/docs/issues-prs/code-reviews) gracefully.
</Card>

<Card title="Handling Rejection" icon={<Bug className="h-5 w-5" />}>
