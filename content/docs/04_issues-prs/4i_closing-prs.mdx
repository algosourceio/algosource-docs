...
import { X, CheckCircle, GitMerge, Archive, Trash2 } from 'lucide-react'

<Callout type="info" title="Every PR Needs a Conclusion">
...
<CardGrid>
<Card title="Merged Successfully" icon={<GitMerge className="h-5 w-5" />}>
PR was approved and merged by maintainer.
</Card>

<Card title="Rejected/Won't Merge" icon={<X className="h-5 w-5" />}>
Maintainer closed it or said it won't be accepted.
</Card>

<Card title="You Can't Continue" icon={<Archive className="h-5 w-5" />}>
Life happened, you don't have time anymore.
</Card>

<Card title="Superseded by Another" icon={<CheckCircle className="h-5 w-5" />}>
Someone else's PR solved it first/better.
</Card>
</CardGrid>
...
<Callout type="success" title="After Merge">
...
<Callout type="warning" title="Usually Better to Start Fresh">
...
<CardGrid>
<Card title="Open Source Programs" icon={<CheckCircle className="h-5 w-5" />}>
Explore [programs that can accelerate your journey](/docs/programs).
</Card>

<Card title="Choosing Organizations" icon={<Archive className="h-5 w-5" />}>
