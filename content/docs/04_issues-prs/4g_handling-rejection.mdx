...
import { XCircle, Heart, TrendingUp, MessageCircle, GitPullRequest } from 'lucide-react'

<Callout type="warning" title="This Will Happen to You">
...
<CardGrid>
<Card title="Out of Scope" icon={<XCircle className="h-5 w-5" />}>
Your solution doesn't align with project goals or roadmap.
</Card>

<Card title="Quality Issues" icon={<TrendingUp className="h-5 w-5" />}>
Code doesn't meet project standards, lacks tests, or has bugs.
</Card>

<Card title="Duplicate Work" icon={<GitPullRequest className="h-5 w-5" />}>
Someone else solved it first, or solution already exists.
</Card>

<Card title="Timing" icon={<MessageCircle className="h-5 w-5" />}>
...
<Callout type="info" title="Take 24 Hours">
...
<Warning title="You Can't Force a Merge">
...
<Callout type="warning" title="Know When to Walk Away">
...
<CardGrid>
<Card title="Iterating on Feedback" icon={<TrendingUp className="h-5 w-5" />}>
Learn [how to improve](/docs/issues-prs/iterating-feedback) based on feedback.
</Card>

<Card title="Closing PRs Properly" icon={<XCircle className="h-5 w-5" />}>
