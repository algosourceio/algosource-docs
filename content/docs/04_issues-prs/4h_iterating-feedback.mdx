...
import { RefreshCw, Zap, Target, CheckCircle, Clock } from 'lucide-react'

<Callout type="success" title="Iteration is Where Learning Happens">
...
<Steps>
<Step number={1} title="Read All Feedback First">
Don't fix as you read. Get the full picture.
</Step>

<Step number={2} title="Group Similar Issues">
Bundle related fixes into logical commits.
</Step>

<Step number={3} title="Fix High Priority First">
P0 and P1 before moving to P2 and P3.
</Step>

<Step number={4} title="Push Once Per Group">
Not after every single fix.
</Step>

<Step number={5} title="Comment on All Changes">
...
<Callout type="warning" title="Push Back on Scope Creep">
...
<CardGrid>
<Card title="Closing PRs Properly" icon={<CheckCircle className="h-5 w-5" />}>
Learn [how to close PRs](/docs/issues-prs/closing-prs) the right way.
</Card>

<Card title="Open Source Programs" icon={<Target className="h-5 w-5" />}>
