...
import { Clock, Calendar, TrendingUp, AlertTriangle, Target, Timer } from 'lucide-react'
...
<CardGrid>
<Card title="Batch Your Work" icon={<Timer className="h-5 w-5" />}>
...
<ChecklistItem>I accept that context switching will add overhead</ChecklistItem>
</Checklist>

<NextSteps items={[
  { title: "Roles in Open Source", description: "Beginner → Contributor → Maintainer", href: "/docs/before-you-start/roles" },
