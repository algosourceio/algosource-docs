...
<Checklist>
<ChecklistItem>**Active maintenance**: Recent commits and releases</ChecklistItem>
<ChecklistItem>**Clear communication**: README and CONTRIBUTING guides</ChecklistItem>
<ChecklistItem>**Welcoming community**: Good-first-issues or beginner help</ChecklistItem>
<ChecklistItem>**Code quality**: Tests and clear architecture</ChecklistItem>
<ChecklistItem>**Good vibes**: Positive community tone</ChecklistItem>
<ChecklistItem>**Right level**: Not too easy, not impossible</ChecklistItem>
</Checklist>
