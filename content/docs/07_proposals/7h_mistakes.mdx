...
<Checklist>
<ChecklistItem>**Specific, not generic** proposal</ChecklistItem>
<ChecklistItem>**Realistic scope** for timeframe</ChecklistItem>
<ChecklistItem>**Prior contributions** demonstrated</ChecklistItem>
<ChecklistItem>**Detailed timeline** with milestones</ChecklistItem>
<ChecklistItem>**Contingency plans** included</ChecklistItem>
<ChecklistItem>**Addresses brief** directly</ChecklistItem>
<ChecklistItem>**Proofread** for grammar</ChecklistItem>
<ChecklistItem>**Reasonable length** (5-10 pages)</ChecklistItem>
<ChecklistItem>**References facts**, not assumptions</ChecklistItem>
<ChecklistItem>**Asks mentor** for feedback</ChecklistItem>
</Checklist>
