...
<Step>**Phase 3: Draft Proposal (Early Mar)**
...
<Warning title="Proposal Killers">
...
<Checklist>
<ChecklistItem>**Blog post or update** on progress</ChecklistItem>
<ChecklistItem>**At least one PR** submitted or merged</ChecklistItem>
<ChecklistItem>**Active in community** channels</ChecklistItem>
<ChecklistItem>**Sync with mentor** (async or call)</ChecklistItem>
<ChecklistItem>**Update project board** or tracking doc</ChecklistItem>
</Checklist>
...
<Step href="https://summerofcode.withgoogle.com">
