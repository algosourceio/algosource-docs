...
<h4 className="font-semibold text-emerald-400 mb-2">Communication</h4>
<p className="text-sm text-neutral-300">Can you write clear bug reports, PR descriptions, and issue comments? Can you explain technical concepts in writing?</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-blue-400 mb-2">Research</h4>
<p className="text-sm text-neutral-300">Can you find answers in documentation before asking? Can you search effectively through codebases?</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-purple-400 mb-2">Patience</h4>
<p className="text-sm text-neutral-300">Can you wait weeks for a review? Can you handle rejection gracefully? Can you persist through confusion?</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-amber-400 mb-2">Time Management</h4>
<p className="text-sm text-neutral-300">Can you commit consistent time? Can you break down tasks? Can you estimate effort?</p>
</div>
</div>
