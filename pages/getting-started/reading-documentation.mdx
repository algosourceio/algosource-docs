...
<h4 className="font-semibold text-emerald-400 mb-2">Project Purpose</h4>
<p className="text-sm text-neutral-300">What problem does this solve? Who is it for? Understanding purpose helps you contribute meaningfully.</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-blue-400 mb-2">Tech Stack</h4>
<p className="text-sm text-neutral-300">Languages, frameworks, dependencies. Do you have the skills needed?</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-purple-400 mb-2">Setup Instructions</h4>
<p className="text-sm text-neutral-300">Prerequisites, installation steps, configuration. Follow these exactly.</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-amber-400 mb-2">Project Structure</h4>
<p className="text-sm text-neutral-300">Directory layout, key files, architecture overview.</p>
</div>
</div>
