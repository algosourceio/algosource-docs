...
<Cards>
<Card title="Editor & IDE Setup" href="/tooling/editors">
VSCode, JetBrains IntelliJ, Vim/Neovim configurations, extensions
</Card>

<Card title="Version Control" href="/git-github">
Git workflows, GitHub CLI, merge tools, branch management
</Card>

<Card title="Linting & Formatting" href="/tooling/linters-ci">
ESLint, Prettier, Black, autopep8, pre-commit hooks
</Card>

<Card title="CI/CD Understanding" href="/tooling/ci-failures">
GitHub Actions, local CI simulation, understanding failures
</Card>

<Card title="Debugging" href="/tooling/debugging">
VSCode debugger, browser DevTools, print debugging, profilers
</Card>

<Card title="Container Tools" href="/tooling/logs-errors">
