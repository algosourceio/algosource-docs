...
<h4 className="font-semibold text-emerald-400 mb-2">Be Specific</h4>
<p className="text-sm text-neutral-300">"The button doesn't work" → "Submit button on /checkout page returns 400 error"</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-blue-400 mb-2">Be Humble</h4>
<p className="text-sm text-neutral-300">"This is broken" → "I'm experiencing unexpected behavior"</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-purple-400 mb-2">Be Helpful</h4>
<p className="text-sm text-neutral-300">Include what you've already tried. Saves back-and-forth.</p>
</div>
</div>
