...
- [ ] Unexpected behavior vs documentation
...
<h4 className="font-semibold text-red-400 mb-2">For Bugs</h4>
<p className="text-sm text-neutral-300">**Provide perfect reproduction steps.** If a maintainer can reproduce in 5 minutes, you're 10x more likely to get a fix.</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-emerald-400 mb-2">For Features</h4>
<p className="text-sm text-neutral-300">**Focus on the problem, not your solution.** Maintainers might have better ideas. Explain the "why" clearly.</p>
</div>

<div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4">
<h4 className="font-semibold text-blue-400 mb-2">For Both</h4>
<p className="text-sm text-neutral-300">**Show community interest.** Link to forum discussions, tweets, or similar requests. Demonstrates real demand.</p>
</div>
</div>
